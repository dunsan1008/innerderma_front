...
| `FilterRow.jsx` | Row of absolutely-positioned sort/filter dropdown labels (성별/나이대/맞춤형 진단) with a caret icon; positions vary per screen via the `top`/`items` props. |
