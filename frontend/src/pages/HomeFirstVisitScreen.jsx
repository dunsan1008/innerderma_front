 ...
 *
 * 값 근거 (실측 기반):
 *  1. 폴백 문구로 렌더한 본문 `scrollHeight` 실측 — 나이트 1567 / 모닝 1665.
 *     → contentBottom 은 나이트 1893 (300+1567+26) / 모닝 1991 (300+1665+26).
 ...
 *     접히는 경우까지 보면 +60px 수준이다. 1991 + 60 → 2050 으로 올려 둔다.
 ...
 */
const FALLBACK_CONTENT_BOTTOM = 2050;
 ...
 * 슬롯의 위 여백(26)과 블록 높이(72)는 `SolutionBody` 가 갖고 있으므로 여기서 만들지 않는다.
 *
...
function CaptureCtaButton({ onClick }) {
  return (
    ...
    >
      {/*
        수행 완료 버튼은 Figma 실측 좌표로 글자를 앉혔지만(870:4236), 이 버튼은 원본이 없으니
        flex 중앙 정렬로 둔다. 문구 길이가 바뀌어도(번역 재개 시) 중앙을 유지한다.
      */}
